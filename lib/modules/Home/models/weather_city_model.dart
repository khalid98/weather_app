...
class WeatherCityModel {
  ...
  factory WeatherCityModel.fromRawJson(String str) => WeatherCityModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WeatherCityModel.fromJson(Map<String, dynamic> json) => WeatherCityModel(
